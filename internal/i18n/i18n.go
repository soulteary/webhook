...
const (
	...
	ERROR_SETUID_OR_SETGID              = "ERROR_SETUID_OR_SETGID"
	ERRPR_SERVER_LISTENING_PORT         = "ERRPR_SERVER_LISTENING_PORT"
	ERRPR_SERVER_LISTENING_PRIVILEGES   = "ERRPR_SERVER_LISTENING_PRIVILEGES"
	ERROR_SERVER_OPENING_LOG_FILE       = "ERROR_SERVER_OPENING_LOG_FILE"
	ERROR_CREATING_PID_FILE             = "ERROR_CREATING_PID_FILE"
	ERROR_COULD_NOT_LOAD_ANY_HOOKS      = "ERROR_COULD_NOT_LOAD_ANY_HOOKS"
	ERROR_VALIDATE_INVALID_PORT         = "ERROR_VALIDATE_INVALID_PORT"
	ERROR_VALIDATE_DIR_NOT_EXIST        = "ERROR_VALIDATE_DIR_NOT_EXIST"
	ERROR_VALIDATE_DIR_ACCESS_ERROR     = "ERROR_VALIDATE_DIR_ACCESS_ERROR"
	ERROR_VALIDATE_DIR_NOT_WRITABLE     = "ERROR_VALIDATE_DIR_NOT_WRITABLE"
	ERROR_VALIDATE_NOT_DIRECTORY        = "ERROR_VALIDATE_NOT_DIRECTORY"
	ERROR_VALIDATE_FILE_NOT_EXIST       = "ERROR_VALIDATE_FILE_NOT_EXIST"
	ERROR_VALIDATE_FILE_ACCESS_ERROR    = "ERROR_VALIDATE_FILE_ACCESS_ERROR"
	ERROR_VALIDATE_NOT_FILE             = "ERROR_VALIDATE_NOT_FILE"
	ERROR_VALIDATE_FILE_NOT_READABLE    = "ERROR_VALIDATE_FILE_NOT_READABLE"
	ERROR_VALIDATE_INVALID_TIMEOUT      = "ERROR_VALIDATE_INVALID_TIMEOUT"
	ERROR_VALIDATE_TIMEOUT_LOGIC        = "ERROR_VALIDATE_TIMEOUT_LOGIC"
	ERROR_VALIDATE_INVALID_RATE_LIMIT   = "ERROR_VALIDATE_INVALID_RATE_LIMIT"
	ERROR_VALIDATE_INVALID_POSITIVE_INT = "ERROR_VALIDATE_INVALID_POSITIVE_INT"
	ERROR_VALIDATE_HOOK_FILE_LOAD_ERROR = "ERROR_VALIDATE_HOOK_FILE_LOAD_ERROR"
	ERROR_VALIDATE_HOOK_ID_EMPTY        = "ERROR_VALIDATE_HOOK_ID_EMPTY"
	ERROR_VALIDATE_HOOK_ID_DUPLICATE    = "ERROR_VALIDATE_HOOK_ID_DUPLICATE"
	// 兼容 validate.go 中使用的常量
